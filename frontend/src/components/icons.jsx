export function PencilIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 20l1.2-4.5L15 5.7l3.3 3.3L8.5 18.8 4 20z" />
      <path d="M13.2 7.5l3.3 3.3" />
    </svg>
  );
}
...
export function EraserIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4.5 15.5 13 7l5 5-6.5 6.5H8L4.5 15.5Z" />
      <path d="M9.5 20.5H19" />
    </svg>
  );
}
...
export function FillIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3.5 11 11 3.5l9.5 9.5-6 6a4.2 4.2 0 0 1-6 0l-4.5-4.5a4.2 4.2 0 0 1 0-6Z" />
      <path d="M9 4.5 19.5 15" />
...
export function DropperIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14.8 9.2 6 18l-2.5.5L4 16l8.8-8.8" />
    </svg>
  );
}
